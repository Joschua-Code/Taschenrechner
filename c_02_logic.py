...
#text=f"{self.gui.number1.get():.2f}
    ...
    def set_number_2(self):
        if self.gui.number2_null.get():
    ...
    def clear(self):
        ...
        self.gui.number1_comma_position.set(0)
        self.gui.number2_comma_position.set(0)
        self.check()
    ...
    def comma_pressed(self):
        if self.gui.entry_at_field_one.get():
            self.gui.number1_comma_position.set(self.gui.number1_comma_position.get() + 1)
            print("Number 1 is comma ready.", self.gui.number1_comma_position.get())
        else:
            self.gui.number2_comma_position.set(self.gui.number2_comma_position.get() + 1)
    ...
    def enter_number(self, x):
        if self.gui.entry_at_field_one.get(): # --- For Number 1 ---
            ...
            elif self.gui.number1_comma_position.get() > 0:
                self.gui.number1.set(self.gui.number1.get() + x * (0.1 ** self.gui.number1_comma_position.get()))
                self.gui.number1_comma_position.set(self.gui.number1_comma_position.get() + 1)
                print(self.gui.number1_comma_position.get())
            ...
            elif self.gui.number2_comma_position.get() > 0: #The new number shall be fractional
                self.gui.number2.set(self.gui.number2.get() + x * (0.1 ** self.gui.number2_comma_position.get()))
                self.gui.number2_comma_position.set(self.gui.number1_comma_position.get() + 1)
                #set_next_number_behind_comma.set(False)
